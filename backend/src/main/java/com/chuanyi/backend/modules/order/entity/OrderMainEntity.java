...
public class OrderMainEntity {
    ...
    private String preoccupyStatus;
    ...
    public String getPreoccupyStatus() {
        return preoccupyStatus;
    }

    public void setPreoccupyStatus(String preoccupyStatus) {
        this.preoccupyStatus = preoccupyStatus;
    }
