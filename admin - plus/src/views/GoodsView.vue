<template>
    ...
    <template #header>
      <div class="admin-page__header">
        <div class="admin-page__heading">
          <div class="admin-page__title"><el-icon><Goods /></el-icon><span>好物管理</span></div>
          <div class="admin-page__subtitle">统一商品与 SKU 的编辑节奏</div>
        </div>
  ...
  <el-drawer v-model="editVisible" title="编辑商品" size="760px" :destroy-on-close="true">
    <div v-loading="editLoading">
      ...
      <div class="sku-head">
        <h4 class="admin-section-title">SKU 列表</h4>
