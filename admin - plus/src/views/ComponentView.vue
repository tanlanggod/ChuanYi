    ...
    <template #header>
      <div class="admin-page__header">
        <div class="admin-page__heading">
          <div class="admin-page__title"><el-icon><Box /></el-icon><span>素材库管理</span></div>
          <div class="admin-page__subtitle">分类管理与 SKU 管理统一视觉层级</div>
        </div>
        <div class="admin-page__actions"><el-tag type="info">分类 + SKU</el-tag></div>
      </div>
    </template>
    ...
    <el-tabs v-model="activeTab">
      ...
      <el-tab-pane label="SKU 管理" name="sku">
        <div class="admin-page__toolbar">
          ...
          <el-button type="primary" :loading="skuLoading" @click="searchSku" :icon="'Search'">查询</el-button>
          <el-button @click="resetSku" :icon="'Refresh'">重置</el-button>
