<template>
  <el-card class="admin-page">
    <template #header>
      <div class="admin-page__header">
        <div class="admin-page__heading">
          <div class="admin-page__title"><el-icon><Tickets /></el-icon><span>订单管理</span></div>
          <div class="admin-page__subtitle">筛选订单、处理发货与状态流转</div>
        </div>
    ...
    <div class="admin-page__toolbar table-tools">
  ...
  <el-drawer v-model="detailVisible" title="订单详情" size="760px" :destroy-on-close="true">
    <div v-loading="detailLoading">
      <template v-if="detail">
        ...
        <h4 class="admin-section-title">商品明细</h4>
        ...
        <h4 class="admin-section-title">操作日志</h4>
        <el-timeline>
          <el-timeline-item
