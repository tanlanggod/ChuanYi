<template>
  <el-card>
    <template #header>
      <div class="header">
        <span>内容管理</span>
        <el-tag type="info">Banner / 设计广场</el-tag>
      </div>
    </template>
    ...
    <el-tabs v-model="activeTab" @tab-change="handleTabChange">
      <el-tab-pane label="Banner 管理" name="banner">
        <div class="toolbar">
          ...
          <el-button type="primary" :loading="bannerLoading" @click="searchBanner">查询</el-button>
      ...
      <el-tab-pane label="设计广场管理" name="gallery">
        <div class="toolbar">
          ...
          <el-button type="primary" :loading="galleryLoading" @click="searchGallery">查询</el-button>
          <el-button @click="resetGallery">重置</el-button>
          <el-button
            type="primary"
            plain
    ...
    <el-tabs v-model="jumpPickerTab" @tab-change="handleJumpPickerTabChange">
      <el-tab-pane label="商品（GOODS）" name="goods">
        <div class="picker-toolbar">
          ...
          />
          <el-button type="primary" :loading="jumpPickerLoading" @click="searchJumpGoods">查询</el-button>
        </div>
      ...
      <el-tab-pane label="设计广场（GALLERY）" name="gallery">
        <div class="picker-toolbar">
          ...
          />
          <el-button type="primary" :loading="jumpPickerLoading" @click="searchJumpGallery">查询</el-button>
        </div>
