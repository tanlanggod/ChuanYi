  ...
  <el-card>
    <template #header>
      <div class="header">
        ...
        <div class="header-actions">
          ...
          />
          <el-select v-model="query.status" placeholder="全部状态" clearable class="w180">
    ...
    <div class="table-tools">
      <div class="summary-group">
        <el-tag type="warning">待支付 {{ statusSummary.pendingPay }}</el-tag>
        <el-tag type="primary">待发货 {{ statusSummary.paidWaitShip }}</el-tag>
        <el-tag type="success">待收货 {{ statusSummary.shippedWaitReceive }}</el-tag>
        <el-tag>已完成 {{ statusSummary.completed }}</el-tag>
        <el-tag type="info">已取消 {{ statusSummary.cancelled }}</el-tag>
      </div>
